...
export default function Login() {
  ...
  const { register, handleSubmit, formState: { isSubmitting } } = useForm<schemaForm>({
  ...
  const sendForm = async (values: schemaForm) => {
    try {
      ...
      if (axiosError.response?.data?.codeIntern === 'ATH_0004') {
        addToast({
          title: "E-mail ou senha incorretos. Verifique suas credenciais e tente novamente.",
          color: 'danger',
        });
      } else {
        addToast({
  ...
  return (
    <div className="min-h-screen bg-gray-50  flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg dark:bg-gray-50">
